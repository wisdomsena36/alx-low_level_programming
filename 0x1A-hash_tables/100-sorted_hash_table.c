...
/**
 * print_ht - It prints hash table state
...
/**
 * shash_table_create - It creates a hash table
...
/**
 * new_snode - It allocates a new node with checking
 * @key: the string key
...
/**
 * shash_table_sort - It sorts the new node
...
/**
 * shash_table_set - It adds an element to a shash table
...
/**
 * shash_table_get - It gets an element from a hash table
 * @ht: pointer to hash table
 * @key: the string key
 *
...
/**
 * shash_table_print - It prints the elements of a hash table
 * @ht: pointer to hash table
 *
 * Return: void.
 */
...
/**
 * shash_table_print_rev - It prints the elements of a hash table in reverse
 * @ht: pointer to hash table
 *
 * Return: void.
 */
